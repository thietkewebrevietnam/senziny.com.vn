<?php
$class_topbar_text = 'col-sm-6 col-md-8 topbar-text';
?>
		...
		<div class="container">
			<div class="row">
				...
				if ( zidane_framework()->is_request( 'wpml' ) ) {
					?>
					<div class="col-sm-12 wpml-widgets col-md-3">
						<div class="inner clearfix">
							<?php do_action( "inspius_custom_wpml_switcher" ); ?>
						</div>
					</div>
					<?php
					$class_topbar_text = 'col-sm-6 col-md-5 text-center topbar-text';
				}
				?>

				<div class="<?php echo $class_topbar_text ?>">
			...
			<div class="container">
				<div class="header-inner">
					<div class="row">
						...
						<div class="col-sm-7 hidden-sm hidden-sm header-menu">
						...
						<div class="col-sm-7 col-md-2 header-action">
							<div class="inner">
