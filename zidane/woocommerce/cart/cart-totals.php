...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table class="no-border shop_table" cellspacing="0">
	...
	<div class="wc-proceed-to-checkout">
		<input type="submit" class="button button-white" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'woocommerce' ); ?>" />
