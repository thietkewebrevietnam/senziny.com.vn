...
<div class="images">
	...
	if ( has_post_thumbnail() ) {
		...
		echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a href="%s" itemprop="image" class="yith_magnifier_zoom woocommerce-main-image" title="%s">%s</a>', $magnifier_url, $image_title, $image ), $post_id );

	} else {
		echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a href="%s" itemprop="image" class="yith_magnifier_zoom woocommerce-main-image"><img src="%s" alt="Placeholder" /></a>', $placeholder, $placeholder ), $post_id );
	}
	?>
...
<script type="text/javascript" charset="utf-8">
	var yith_magnifier_options = {
		...
		enableSlider: <?php echo false ? 'true' : 'false' ?>,
